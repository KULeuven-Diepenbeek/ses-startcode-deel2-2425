...
public class Assignment05_Streams_Tests {
    ...
    @Test
    public void test_match_detects_null() {
        var size = new BoardSize(6, 6);
        var positions = Arrays.asList(new Position(0, 0, size), null, new Position(0, 2, size));
        assertThatIllegalArgumentException().isThrownBy(() -> new Match(positions)).withMessage("positions contains null elements");
    }
    ...
    @Test
    public void test_match_rejects_non_adjacent_on_same_column() {
        var size = new BoardSize(6, 6);
        var positions = List.of(
                new Position(0, 0, size),
    ...
    @Test
    public void test_match_accepts_horizontal_match_of_size_4() {
        var size = new BoardSize(6, 6);
        var positions = List.of(
                new Position(1, 1, size),
                new Position(1, 2, size),
    ...
    @Test
    public void test_first_two_candies_equal_too_short() {
        var candy0 = new Candy.NormalCandy(0);
        var candy1 = new Candy.NormalCandy(1);
        var stream = Stream.of(candy0);

        assertThat(CandyCrushGame.firstTwoEqual(candy0, stream)).isFalse();
    }

    @Test
    public void test_horizontal_starting_positions() {
        ...
        assertThatStream(gameModel.horizontalStartingPositions()).containsExactlyInAnyOrderElementsOf(positions);
    }
    ...
    @Test
    public void test_longest_match_to_right_length_1() {
        var gameModel = Util.createBoardFromString("""
                *****#""");
        var size = gameModel.getSize();
    ...
    @Test
    public void test_longest_match_to_right_length_2() {
        var gameModel = Util.createBoardFromString("""
                *****#""");
        var size = gameModel.getSize();
    ...
    @Test
    public void test_longest_match_down_length_1() {
        var gameModel = Util.createBoardFromString("""
                *
                *
                *
    ...
    @Test
    public void test_longest_match_down_length_5() {
        var gameModel = Util.createBoardFromString("""
                *
                *
                *
